...
proxmox_shared_storage_pool = "$PROXMOX_SHARED_STORAGE_POOL"
...
dev_playground ansible_host=$(tofu output dev_playground_ips) ansible_password=P@ssw0rd ansible_python_interpreter=auto_silent
